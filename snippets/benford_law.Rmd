...
-   Similar to Zipf's law: for a corpus of natural language: the frequency of any word is inversely proportional to its rank in the frequency table.
    ...
    -   Ex: TTe most frequent word will occur approximately twice as often as the second most frequent word, three times as often as the third most frequent word

-   **Newcomb--Benford law**, the **law of anomalous numbers**, or the **first-digit law**

    -   In an natural numerical data, the leading digit is likely to be small:
